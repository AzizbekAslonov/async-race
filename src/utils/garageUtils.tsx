...
export const getCarDistance = (el: HTMLElement) => {
  const parent = el.closest(".ant-list-item") as HTMLElement;
  const { offsetWidth, offsetLeft } = el;
  return parent.offsetWidth - offsetWidth - offsetLeft;
};
